...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/02/16 18:56:05 by omakovsk          #+#    #+#             */
/*   Updated: 2019/02/16 18:56:06 by omakovsk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	salt_password(t_crypt_info *crypt_info)
{
	...
	ft_memcpy(&crypt_info->flags.password[old_pass_len],
			crypt_info->flags.salt, 8);
